...
fada_bem_rect.centerx = WIDTH // 2  # Centraliza a fada mal horizontalmente
fada_bem_rect.bottom = HEIGHT  # Posiciona a fada mal no topo da janela
...
while game:
    ...
    window.blit(imagem_fada_bem, fada_bem_rect)  
