...
def load_assets():
    assets = {}
    assets[BACKGROUND] = pygame.image.load(os.path.join(IMG_DIR, 'Fundo_pygame.png')).convert()
    assets[BACKGROUND] = pygame.transform.scale(assets['Fundo_pygame.png'], (600, 400))
